...
public class CameraConnectbak extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	...
	public CameraConnectbak(Context context) {
		super(context);
	...
	public CameraConnectbak(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		if(DEBUG) Log.d(TAG,"CameraPreview constructed");
		setFocusable(true);
