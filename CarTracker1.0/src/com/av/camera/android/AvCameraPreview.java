...
public class AvCameraPreview extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	...
	public AvCameraPreview(Context context) {
		super(context);
	...
	public AvCameraPreview(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		if(DEBUG) Log.d(TAG,"CameraPreview constructed");
		setFocusable(true);
