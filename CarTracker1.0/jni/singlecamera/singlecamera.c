...
void 
Java_com_usb_camera_android_SingleCameraPreview_pixeltobmp( JNIEnv* env,jobject thiz,jobject bitmap){
...
jint 
Java_com_usb_camera_android_SingleCameraPreview_prepareCamera( JNIEnv* env,jobject thiz, jint videoid){
...
jint 
Java_com_usb_camera_android_SingleCameraPreview_prepareCameraWithBase( JNIEnv* env,jobject thiz, jint videoid, jint videobase){
	
		int ret;

		camerabase = videobase;
	
		return Java_com_usb_camera_android_SingleCameraPreview_prepareCamera(env,thiz,videoid);
	
}

void 
Java_com_usb_camera_android_SingleCameraPreview_processCamera( JNIEnv* env,
										jobject thiz){
